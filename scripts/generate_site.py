...
SITE_URL = os.environ.get('SITE_URL', 'https://kamowakaru.github.io/tamarukamo').rstrip('/')
...
def shell(title, body, prefix='../', desc='', canonical_path='', json_ld='', noindex=False,
    ...
    return f'''<!doctype html><html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="{html.escape(desc)}">{robots}<link rel="canonical" href="{html.escape(canonical)}"><meta property="og:title" content="{html.escape(title)}"><meta property="og:description" content="{html.escape(desc)}"><meta property="og:url" content="{html.escape(canonical)}"><meta property="og:type" content="{page_type}"><meta property="og:image" content="{html.escape(image)}"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="{html.escape(title)}"><meta name="twitter:description" content="{html.escape(desc)}"><meta name="twitter:image" content="{html.escape(image)}"><title>{html.escape(title)} | タマルカモ</title><link rel="stylesheet" href="{prefix}assets/css/style.css?v=20260919-3"><link rel="stylesheet" href="{prefix}assets/css/point.css"><link rel="stylesheet" href="{prefix}assets/css/article-markdown.css?v=20260918-images">{schema}</head><body data-root="{prefix}"><header class="site-header"><div class="container header-inner"><a class="brand" href="{prefix}index.html"><img src="{prefix}assets/images/logo-duck.webp" alt=""><span><strong>タマルカモ</strong><small>無理なく続けて、貯まるかも。</small></span></a><button class="menu-btn" aria-label="メニュー">☰</button><nav class="nav">{nav}</nav><form class="header-search" action="{prefix}search.html"><input name="q" type="search" placeholder="キーワードで検索…"><button>🔍</button></form></div></header>{body}<footer class="footer"><div class="container footer-inner"><div class="footer-brand"><img src="{prefix}assets/images/logo-duck.webp" alt=""><div><strong>タマルカモ</strong><div style="font-size:12px;color:#6c7c91">無理なく続けて、貯まるかも。</div></div></div><div class="footer-links"><a href="{prefix}index.html">ホーム</a><a href="{prefix}articles.html">記事一覧</a><a href="{prefix}about.html">このサイトについて</a><a href="{prefix}privacy.html">プライバシーポリシー</a></div></div><p class="copyright">© 2026 タマルカモ</p></footer><script src="{prefix}assets/js/analytics-config.js"></script><script src="{prefix}assets/js/site.js?v=20260914-2"></script></body></html>'''
...
for a in articles:
    ...
    point = ''
    if a['point']:
        point = f'''<aside class="point yellow tamarukamo-point"><div class="point-heading"><img src="../assets/images/tamarukamo-point.png" alt=""><strong>タマルカモポイント</strong></div><p>{html.escape(a['point'])}</p></aside>'''
    author_box = '''<section class="author-box" aria-labelledby="author-box-title"><img src="../assets/images/tip-duck.webp" alt="タマルカモ運営者"><div><span id="author-box-title" class="author-label">この記事を書いた人</span><strong>タマルカモ運営者</strong><p>家計管理や節約、資産形成について、自分で調べて試したことを初心者向けに整理しています。</p><a href="../about.html#author-profile">運営者情報を見る →</a></div></section>'''
...
home_schema = json.dumps({'@context':'https://schema.org','@graph':[
    {'@type':'WebSite','name':'タマルカモ','url':f'{SITE_URL}/','potentialAction':{'@type':'SearchAction','target':f'{SITE_URL}/search.html?q={{search_term_string}}','query-input':'required name=search_term_string'}},
    {'@type':'Organization','name':'タマルカモ','url':f'{SITE_URL}/','logo':f'{SITE_URL}/assets/images/logo-duck.webp'}
]}, ensure_ascii=False).replace('</', '<\\/')
update_static_seo(ROOT/'index.html', '', 'タマルカモ｜節約・家計管理・NISAを初心者向けに解説', '節約・家計管理・NISA・資産形成を、初心者向けにわかりやすく解説するブログです。', json_ld=home_schema)
update_static_seo(ROOT/'articles.html', 'articles.html', '記事一覧', 'タマルカモの記事一覧です。')
update_static_seo(ROOT/'search.html', 'search.html', '検索', 'タマルカモの記事を検索できます。', noindex=True)
update_static_seo(ROOT/'about.html', 'about.html', 'このサイトについて', 'タマルカモの方針と運営者情報です。')
update_static_seo(ROOT/'privacy.html', 'privacy.html', 'プライバシーポリシー', 'タマルカモのプライバシーポリシーです。')
